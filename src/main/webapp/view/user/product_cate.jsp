			...
			<c:forEach items="${listResponses.data}" var="product">
				<div class="collection-item">
					...
					<div class="image-cate">
						<c:forEach items="${product.productSkus}" var="sku" varStatus="status">
							<img src="<c:url value='${sku.img}' />" alt="${sku.color} Image" onclick="selectImage(this, '${sku.productColorImgId}', '${sku.img}', '${fn:escapeXml(sku.sizeAndStock)}', '${product.typeProduct}')" />
						</c:forEach>
					</div>
