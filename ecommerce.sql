...
CREATE TABLE `order` (
                         `id` int NOT NULL,
                         `user_id` int DEFAULT NULL,
                         `order_status` enum('ĐANG_CHỜ','ĐÃ_HOÀN_THÀNH','ĐÃ_HỦY') COLLATE utf8mb4_general_ci NOT NULL,
                         ...
                         `sign` text COLLATE utf8mb4_general_ci,
...
--
-- Cấu trúc bảng cho bảng `publickeystorage`
--
...
--
-- Đang đổ dữ liệu cho bảng `publickeystorage`
--
...
--
-- Chỉ mục cho bảng `publickeystorage`
--
